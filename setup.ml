...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2c9555b14cbbc3a9d64cdfdab1f83635) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors =
            ["Remy El Siba\195\175e"; "Jean-Christophe Filli\195\162tre"];
          homepage = None;
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "sudoku.ml"});
               Executable
                 ({
                     cs_name = "backslide";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_path = "examples/lib";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "combine"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "backslide.ml"});
               Executable
                 ({
                     cs_name = "color";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "color.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Combine";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "JAJ\197\163X4\179\"N\222\148\210(\253\224";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
