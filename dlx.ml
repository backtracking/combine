...
(* Recouvre : retire une colonne et les lignes correspondant aux elts de la
 colonne *)
...
(* Découvre : rajoute une colonne et les lignes correspondant aux elts de la
colonne *)
...
let find_solution m =
  ...
  in
  let o = Array.init (Array.length m) (fun _ -> one_node ()) in
