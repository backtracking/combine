...
\begin{abstract}
  Cet article présente \reml, une bibliothèque OCaml pour la
...
% \InsertBoxR{2}{\includegraphics{caml_problem.mps}}

% \InsertBoxL{0}{\includegraphics{caml_solution.mps}}%
...
\section{Réalisation} % = détails techniques
