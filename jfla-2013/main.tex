...
la forme d'un graphe orienté acyclique. On peut alors effectuer des
opérations entre ZDD, comme par exemple la conjonction ou les
...
1 dans cette colonne. Puis on fait l'intersection de tous ces ZDD.
Cette technique a les avantages et inconvénients usuels des BDD. Si on
...
partage, comme pour un BDD). C'est ainsi qu'on a calculé le nombre
